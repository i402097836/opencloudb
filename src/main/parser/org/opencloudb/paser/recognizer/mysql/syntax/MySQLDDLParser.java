...
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_BINARY;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_CHARACTER;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_COLLATE;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_COLUMN;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_DEFAULT;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_EXISTS;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_IF;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_IGNORE;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_INDEX;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_KEY;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_KEYS;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_NOT;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_ON;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_SET;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_TABLE;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_TO;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_UNSIGNED;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_USING;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.KW_ZEROFILL;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.LITERAL_NULL;
import static org.opencloudb.paser.recognizer.mysql.MySQLToken.LITERAL_NUM_PURE_DIGIT;
...
import org.opencloudb.paser.ast.ddl.index.IndexDefinition;
import org.opencloudb.paser.ast.ddl.index.IndexOption;
import org.opencloudb.paser.ast.expression.Expression;
import org.opencloudb.paser.ast.expression.function.literal.Literal;
        ...
        for (;;) {
            ...
            case KW_USING:
                ...
                IndexOption.IndexType indexType =
                        matchIdentifier("BTREE", "HASH") == 0
                                ? IndexOption.IndexType.BTREE
