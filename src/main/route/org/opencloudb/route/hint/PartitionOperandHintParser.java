...
public final class PartitionOperandHintParser extends HintParser {
     ...
     * 
     * @param len
     *            less than 0 for array length unknown
     */
    private Object[] parseArray(MycatHint hint, String sql, int len) throws SQLSyntaxErrorException {
        Object[] rst = null;
     ...
     */
    private Object[][] parseArrayArray(MycatHint hint, String sql, int columnNum) throws SQLSyntaxErrorException {
        if (nextChar(hint, sql) == '[') {
