...
import org.opencloudb.route.config.RouteRuleInitializer;
import org.opencloudb.route.util.PermutationUtil.PermutationGenerator;
...
public class ServerRouteTest extends AbstractAliasConvert {
    ...
    public void testRoute() throws Exception {
        ...
        sqlAsserter.addExpectSQL(0, "SELECT * FROM wp_image WHERE member_id = 'pavarotti17' OR FALSE").addExpectSQL(1,
        ...
        Assert.assertEquals((int) RouteResultsetNode.DEFAULT_REPLICA_INDEX, rrs.getNodes()[0].getReplicaIndex());
        Assert.assertEquals("offer_dn[123]", rrs.getNodes()[0].getName());
        Assert.assertEquals("SELECT * FROM wp_image WHERE member_id BETWEEN 'pavarotti17' AND 'pavarotti17'",
                rrs.getNodes()[0].getStatement());
        ...
        Assert.assertEquals((int) RouteResultsetNode.DEFAULT_REPLICA_INDEX, rrs.getNodes()[0].getReplicaIndex());
        Assert.assertEquals("offer_dn[44]", rrs.getNodes()[0].getName());
        Assert.assertEquals("UPDATE offer AS " + aliasConvert("a") + " INNER JOIN offer_detail AS " + aliasConvert("b")
        ...
        sqlAsserter
                ...
                .addExpectSQL(1,
                        "SELECT * FROM wp_image, tb2 AS " + aliasConvert("t2") + " WHERE member_id IN ('qaa') OR FALSE")
                .addExpectSQL(
                        2,
                        "SELECT * FROM wp_image, tb2 AS " + aliasConvert("t2")
        ...
        sqlAsserter
                ...
                .addExpectSQL(1,
                        "SELECT * FROM tb2 AS " + aliasConvert("t2") + ", wp_image WHERE member_id IN ('qaa') OR FALSE")
                .addExpectSQL(
                        2,
                        "SELECT * FROM tb2 AS " + aliasConvert("t2")
        ...
        Assert.assertEquals((int) RouteResultsetNode.DEFAULT_REPLICA_INDEX, rrs.getNodes()[0].getReplicaIndex());
        Assert.assertEquals("offer_dn[123]", rrs.getNodes()[0].getName());
        Assert.assertEquals("SELECT * FROM wp_image AS " + aliasConvert("wB") + " INNER JOIN offer AS "
                + aliasConvert("o") + " ON wB.member_id = O.member_ID WHERE wB.member_iD = 'pavarotti17' AND o.id = 3",
                rrs.getNodes()[0].getStatement());
        ...
        sqlAsserter.addExpectSQL(
                0,
                "SELECT * FROM wp_image AS " + aliasConvert("w") + " INNER JOIN offer AS " + aliasConvert("o")
    ...
    public void testDuplicatePartitionKey() throws Exception {
        ...
        SimpleSQLAsserter sqlAsserter = new SimpleSQLAsserter();
        sqlAsserter
                .addExpectSQL(0, "SELECT * FROM wp_image WHERE member_id IN ('pavarotti17') OR FALSE OR FALSE")
        ...
        sqlAsserter
                ...
                .addExpectSQL(
                        ...
                        new PermutationGenerator("(123, NOW())", "(123, NOW() + 1)", "(122 + 1, NOW())", "(123, NOW())")
                                .setDelimiter(", "), "");
        asserter = new RouteNodeAsserter(nameAsserter, sqlAsserter);
        for (RouteResultsetNode node : nodeMap.values()) {
            asserter.assertNode(node);
        ...
        nameAsserter = new NodeNameAsserter("offer_dn[58]", "offer_dn[100]", "offer_dn[86]", "offer_dn[72]",
                "offer_dn[114]", "offer_dn[44]", "offer_dn[30]");
        nameAsserter.assertRouteNodeNames(nodeMap.keySet());
        sqlAsserter = new SimpleSQLAsserter();
        sqlAsserter
                .addExpectSQL(
                        ...
                        new PermutationGenerator("(345, 123, NOW())", "(123, 345, NOW())", "(234, 234, NOW())")
                                .setDelimiter(", "), "")
                ...
                .addExpectSQL(
                        2,
                        "INSERT INTO offer (offer_id, group_id, gmt) VALUES ",
                        new PermutationGenerator("(456, 234, NOW())", "(234, 456, NOW())", "(345, 345, NOW())")
                                .setDelimiter(", "), "")
                .addExpectSQL(
                        3,
                        "INSERT INTO offer (offer_id, group_id, gmt) VALUES ",
                        new PermutationGenerator("(123, 456, NOW())", "(345, 234, NOW())", "(234, 345, NOW())",
        ...
        for (int i = 0; i < 128; i++) {
            Assert.assertEquals((int) RouteResultsetNode.DEFAULT_REPLICA_INDEX, rrs.getNodes()[i].getReplicaIndex());
            Assert.assertEquals("offer_dn[" + i + "]", rrs.getNodes()[i].getName());
            Assert.assertEquals("select * from offer where (offer_id, group_id ) = (123,234)",
                    rrs.getNodes()[i].getStatement());
        }
        ...
        sqlAsserter.addExpectSQL(0, sqlTemp).addExpectSQL(1, sqlTemp).addExpectSQL(2, sqlTemp).addExpectSQL(3, sqlTemp)
                .addExpectSQL(4, sqlTemp).addExpectSQL(5, sqlTemp).addExpectSQL(6, sqlTemp);
        asserter = new RouteNodeAsserter(nameAsserter, sqlAsserter);
        for (RouteResultsetNode node : nodeMap.values()) {
            asserter.assertNode(node);
        }
    ...
    public void testGroupLimit() throws Exception {
        ...
        Assert.assertEquals((int) RouteResultsetNode.DEFAULT_REPLICA_INDEX, rrs.getNodes()[0].getReplicaIndex());
        Assert.assertEquals("offer_dn[123]", rrs.getNodes()[0].getName());
        Assert.assertEquals("select count(*) from wp_image where member_id = 'pavarotti17'",
                rrs.getNodes()[0].getStatement());
        ...
        nameAsserter.assertRouteNodeNames(nodeMap.keySet());
        SimpleSQLAsserter sqlAsserter = new SimpleSQLAsserter();
        sqlAsserter.addExpectSQL(0, "SELECT COUNT(*) FROM wp_image WHERE member_id IN ('pavarotti17')").addExpectSQL(1,
    ...
    public void testDimension2Route() throws Exception {
        ...
        Assert.assertEquals("select * from product_visit where member_id='pavarotti17' and product_id=2345",
                rrs.getNodes()[0].getStatement());
        ...
        NodeNameAsserter nameAsserter = new NodeNameAsserter("offer_dn[25]", "offer_dn[17]", "offer_dn[9]",
                "offer_dn[1]", "offer_dn[29]", "offer_dn[21]", "offer_dn[5]", "offer_dn[13]");
        nameAsserter.assertRouteNodeNames(nodeMap.keySet());
        SimpleSQLAsserter sqlAsserter = new SimpleSQLAsserter();
        ...
        nameAsserter = new NodeNameAsserter("offer_dn[0]", "offer_dn[4]", "offer_dn[8]", "offer_dn[12]",
        ...
        nameAsserter = new NodeNameAsserter("offer_dn[0]", "offer_dn[4]", "offer_dn[8]", "offer_dn[12]",
                "offer_dn[16]", "offer_dn[20]", "offer_dn[24]", "offer_dn[28]", "offer_dn[1]", "offer_dn[5]",
                "offer_dn[9]", "offer_dn[13]", "offer_dn[17]", "offer_dn[21]", "offer_dn[25]", "offer_dn[29]");
        nameAsserter.assertRouteNodeNames(nodeMap.keySet());
        sqlAsserter = new SimpleSQLAsserter();
        ...
        Assert.assertEquals(-1l, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 8);
        nameAsserter = new NodeNameAsserter("offer_dn[4]", "offer_dn[5]", "offer_dn[6]", "offer_dn[7]", "offer_dn[8]",
                "offer_dn[9]", "offer_dn[10]", "offer_dn[11]");
        nameAsserter.assertRouteNodeNames(nodeMap.keySet());
        sqlAsserter = new SimpleSQLAsserter();
    ...
    public void testTableMetaRead() throws Exception {
        ...
        NodeNameAsserter nameAsserter = new NodeNameAsserter("detail_dn[0]", "offer_dn[0]", "cndb_dn",
                "independent_dn[0]");
        nameAsserter.assertRouteNodeNames(nodeMap.keySet());
        SimpleSQLAsserter sqlAsserter = new SimpleSQLAsserter();
    ...
    public void testCobarHint() throws Exception {
        SchemaConfig schema = schemaMap.get("cndb");
        String sql = "  /*!mycat: $dataNodeId=2.1, $table='offer'*/ select * from `dual`";
        RouteResultset rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        Assert.assertEquals(1, rrs.getNodes().length);
        ...
        sql = "/*!mycat: $dataNodeId=2.1, $table='offer', $replica =2*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        Assert.assertEquals(1, rrs.getNodes().length);
        Assert.assertEquals(1, rrs.getNodes()[0].getReplicaIndex());
        ...
        sql = "/*!mycat: $dataNodeId   = [ 1,2,5.2]  , $table =  'offer'   */ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        Map<String, RouteResultsetNode> nodeMap = getNodeMap(rrs, 3);
        ...
        sql = "/*!mycat: $dataNodeId   = [ 1,2,5.2]  , $table =  'offer'  , $replica =1 */ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        Assert.assertEquals(3, rrs.getNodes().length);
        nodeMap = getNodeMap(rrs, 3);
        ...
        sql = "/*!mycat: $partitionOperand=( 'member_id' = 'pavarotti17'), $table='offer'*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        Assert.assertEquals(1, rrs.getNodes().length);
        Assert.assertEquals((int) RouteResultsetNode.DEFAULT_REPLICA_INDEX, rrs.getNodes()[0].getReplicaIndex());
        ...
        sql = "/*!mycat:$partitionOperand =   ( 'member_id' = ['pavarotti17'  ,   'qaa' ]  ), $table='offer'  , $replica =  2*/  select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 2);
        nameAsserter = new NodeNameAsserter("offer_dn[123]", "offer_dn[10]");
        ...
        sql = "/*!mycat:$partitionOperand = ( ['group_id','offer_id'] = [234,4]), $table='offer'*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        Assert.assertEquals(1, rrs.getNodes().length);
        Assert.assertEquals((int) RouteResultsetNode.DEFAULT_REPLICA_INDEX, rrs.getNodes()[0].getReplicaIndex());
        ...
        sql = "/*!mycat:$partitionOperand=(['offer_id','group_id']=[[123,3],[234,4]]), $table='offer'  , $replica =2*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 2);
        ...
        sql = "/*!mycat:$partitionOperand=(['group_id','offer_id']=[[123,3], [ 234,4 ] ]), $table='offer'  */ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 2);
        nameAsserter = new NodeNameAsserter("offer_dn[29]", "offer_dn[15]");
        ...
        sql = "/*!mycat:$partitionOperand=(['offer_id','NON_EXistence']=[[123,3],[234,4]]), $table='offer'  , $replica =2*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 128);
        nameAsserter = new IndexedNodeNameAsserter("offer_dn", 0, 128);
        ...
        sql = "/*!mycat:  $dataNodeId   = 1  ,$table =  'wp_image'*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        ...
        sql = "/*!mycat:  $dataNodeId   = [0,3]  ,$table =  'wp_image'*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 2);
        ...
        sql = "/*!mycat:  $table =  'wp_image'*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 128);
        nameAsserter = new IndexedNodeNameAsserter("offer_dn", 0, 128);
        ...
        sql = "/*!mycat:  $dataNodeId   = 0  ,$table =  'independent'*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 1);
        ...
        sql = "/*!mycat:  $dataNodeId   = [ 1,2,5]  ,$table =  'independent'*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 3);
        ...
        sql = "/*!mycat:  $table =  'independent'*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 128);
        nameAsserter = new IndexedNodeNameAsserter("independent_dn", 0, 128);
        ...
        sql = "/*!mycat:$partitionOperand=(['member_id','NON_EXistence']=[['pavarotti17'],['qaa',4]]), $table='offer'  , $replica=2*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        nodeMap = getNodeMap(rrs, 2);
        nameAsserter = new NodeNameAsserter("offer_dn[123]", "offer_dn[10]");
        ...
        sql = "/*!mycat:$partitionOperand=(['offer_id','NON_EXistence']=[[123,3],[234,4]]), $table='non_existence'  , $replica=2*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        Assert.assertEquals(1, rrs.getNodes().length);
        ...
        sql = "/*!mycat:$partitionOperand=(['offer_id','group_id']=[[123,3],[234,4]]), $table='non_existence'  , $replica=2*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        Assert.assertEquals(1, rrs.getNodes().length);
        Assert.assertEquals(2, rrs.getNodes()[0].getReplicaIndex());
        ...
        sql = "/*!mycat: $replica=2*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(-1L, rrs.getLimitSize());
        Assert.assertEquals(1, rrs.getNodes().length);
        Assert.assertEquals(2, rrs.getNodes()[0].getReplicaIndex());
        ...
        schema = schemaMap.get("dubbo");
        sql = "/*!mycat: $dataNodeId = [ 0.1],$replica=2*/ select * from `dual`";
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals(1, rrs.getNodes().length);
        Assert.assertEquals(1, rrs.getNodes()[0].getReplicaIndex());
        Assert.assertEquals("dubbo_dn", rrs.getNodes()[0].getName());
    ...
    public void testIgnoreSchema() throws Exception {
        ...
        rrs = ServerRouter.route(schema, sql, null, null);
        Assert.assertEquals("SELECT * FROM offer WHERE ignoreSchemaTest.offer.offer_id = 1",
                rrs.getNodes()[0].getStatement());
        sql = "insert into offer (group_id, offer_id, gmt) values (234,123,now())";
        schema = schemaMap.get("ignoreSchemaTest0");
        rrs = ServerRouter.route(schema, sql, null, null);
