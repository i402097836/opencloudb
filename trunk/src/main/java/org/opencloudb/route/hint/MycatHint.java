 ...
 * @author mycat
 */
public final class MycatHint {

    // index start from 1
    // /*!mycat: $dataNodeId=0.0, $table='offer'*/
    // /*!mycat: $dataNodeId=[0,1,5.2], $table='offer'*/
    // /*!mycat: $partitionOperand=('member_id'='m1'), $table='offer'*/
    // /*!mycat: $partitionOperand=('member_id'=['m1','m2']), $table='offer',
    // $replica=2*/
    // /*!mycat: $partitionOperand=(['offer_id','group_id']=[123,'3c']),
    // $table='offer'*/
    // /*!mycat:
    // $partitionOperand=(['offer_id','group_id']=[[123,'3c'],[234,'food']]),
    // $table='offer'*/

    public static final String COBAR_HINT_PREFIX = "/*!mycat:";
    ...
    /**
     * @param offset
     *            index of first char of {@link #COBAR_HINT_PREFIX}
     */
    public static MycatHint parserCobarHint(String sql, int offset) throws SQLSyntaxErrorException {
        MycatHint hint = new MycatHint();
    ...
    public MycatHint increaseCurrentIndex() {
        ++currentIndex;
        return this;
    }
