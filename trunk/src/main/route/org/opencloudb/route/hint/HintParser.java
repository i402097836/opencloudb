...
public abstract class HintParser {
    ...
    /**
     * hint's {@link MycatHint#getCurrentIndex()} will be changed to index of
     * next char after process
     */
    public abstract void process(MycatHint hint, String hintName, String sql) throws SQLSyntaxErrorException;

    private void skipSpace(MycatHint hint, String sql) {
    ...
    protected char currentChar(MycatHint hint, String sql) {
        skipSpace(hint, sql);
     ...
     */
    protected char nextChar(MycatHint hint, String sql) {
        skipSpace(hint, sql);
        skipSpace(hint.increaseCurrentIndex(), sql);
        return sql.charAt(hint.getCurrentIndex());
    }

    protected Object parsePrimary(MycatHint hint, String sql) throws SQLSyntaxErrorException {
